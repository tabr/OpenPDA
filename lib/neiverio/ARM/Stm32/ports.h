	...
	namespace Private
	{
		...
		public:			
			...
			{				
				...
				//BSRR::Set((uint32_t)clearMask << 16);
				//BSRR::Set(value);
				//ODR::AndOr(~clearMask, value);
				//ODR::Set(clearMask);
				//ODR::Set(value);
				//ODR::Set(0x124);
			}
...
#ifdef USE_PORTVOID
//You should define uint32_t VoidPortDummyReg; in some .cpp file of your project
extern uint32_t VoidPortDummyReg;
MAKE_PORT(VoidPortDummyReg, VoidPortDummyReg, VoidPortDummyReg, VoidPortDummyReg, VoidPortDummyReg, VoidPortDummyReg, VoidPortDummyReg, 1 << 0, Portvoid, 'V')
#endif
