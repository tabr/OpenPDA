...
GameCFG.RegisterNewRadiomark(new RadiomarkInstanceClass(9,	RadiomarkInstanceClass::RADIOMARK_TYPE_RADIATION_ANOMALY,   0,                      TemporaryClass::ANOMALY_ID_TRAMPLIN,25,                     200));
GameCFG.RegisterNewRadiomark(new RadiomarkInstanceClass(10,	RadiomarkInstanceClass::RADIOMARK_TYPE_RADIATION_ANOMALY,   0,                      TemporaryClass::ANOMALY_ID_TRAMPLIN,25,                     200));
GameCFG.RegisterNewRadiomark(new RadiomarkInstanceClass(11,	RadiomarkInstanceClass::RADIOMARK_TYPE_RADIATION_ANOMALY,   0,                      TemporaryClass::ANOMALY_ID_TRAMPLIN,25,                     200));
GameCFG.RegisterNewRadiomark(new RadiomarkInstanceClass(12,	RadiomarkInstanceClass::RADIOMARK_TYPE_RADIATION_ANOMALY,   0,                      TemporaryClass::ANOMALY_ID_TRAMPLIN,25,                     200));
