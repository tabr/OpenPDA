...
//PDAMenu.PDAMenu_Main.insertBefore(&PDAMenu.PDAMenu_Undertaker);
PDAMenu.PDAMenu_Main.insertBefore(&PDAMenu.PDAMenu_ActionSuicide);
#ifdef MASTER_PDA
  {
...
//  PDAMenu.PDAMenu_Main.insertBefore(&PDAMenu.PDAMenu_MASTER_Artefact);
...
PDAMenu.PDAMenu_Dummy0.addSubMenu(&PDAMenu.PDAMenu_Suit);
