...
defTmp[TemporaryClass::DamageSource::DAMAGE_SOURCE_NONE]					= 10;
defTmp[TemporaryClass::DamageSource::DAMAGE_SOURCE_GENERIC]					= 10;
defTmp[TemporaryClass::DamageSource::DAMAGE_SOURCE_RADIATION_EXTERNAL]		= 10;
defTmp[TemporaryClass::DamageSource::DAMAGE_SOURCE_RADIATION_DOSE_INTERNAL]	= 0;
defTmp[TemporaryClass::DamageSource::DAMAGE_SOURCE_FIRE]					= 10;
defTmp[TemporaryClass::DamageSource::DAMAGE_SOURCE_ELECTRICITY]				= 10;
defTmp[TemporaryClass::DamageSource::DAMAGE_SOURCE_CHEMICAL]				= 10;
defTmp[TemporaryClass::DamageSource::DAMAGE_SOURCE_GRAVY]					= 10;
defTmp[TemporaryClass::DamageSource::DAMAGE_SOURCE_PSY]						= 10;
defTmp[TemporaryClass::DamageSource::DAMAGE_SOURCE_BIO]						= 0;
defTmp[TemporaryClass::DamageSource::DAMAGE_SOURCE_BLOWOUT]					= 0;
c.Set(GameCharacteristicsClass::CHARACTERISTIC_DURABILITY, 600);
c.Set(GameCharacteristicsClass::CHARACTERISTIC_CONTAINERS, 1);
GameCFG.SuitsContainer.container[TemporaryClass::SUIT_ID_NEWBE].setProperties((char*)("Кост.Новичка"),		defTmp,	&c);
