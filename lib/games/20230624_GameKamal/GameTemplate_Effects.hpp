...
*/
  ...
  PlayerEffect_CombinedClass*  Item_Vodka            = new PlayerEffect_CombinedClass(0,1,10, TemporaryClass::PLAYEREFFECT_ITEM_VODKA1, (char*)"vodka");
  PlayerEffect_ModHealthClass* Item_Vodka_Dmg        = new PlayerEffect_ModHealthClass(0,1,10, TemporaryClass::PLAYEREFFECT_ITEM_VODKA2, (char*)"vodka");
  Item_Vodka_Dmg->SetModHealthValue(-1);
  PlayerEffect_ModRadDoseClass* Item_Vodka_Dose      = new PlayerEffect_ModRadDoseClass(0,1,10, TemporaryClass::PLAYEREFFECT_ITEM_VODKA3, (char*)"vodka");
  Item_Vodka_Dose->SetDoseValue(-1);
  PlayerEffects_Interface** Item_Vodka_array         = new PlayerEffects_Interface*[2]{Item_Vodka_Dose, Item_Vodka_Dmg};
  Item_Vodka->SetCombined(Item_Vodka_array,2);
  GameCFG.RegisterNewPlayerEffect(Item_Vodka);
