#ifndef GAMETEMPLATE_TEMPORARY_CLASS_H
#define GAMETEMPLATE_TEMPORARY_CLASS_H

#warning "Baraban game"
...
//		const static uint8_t ANORAD_IDS_NUM				= 32;
		...
		enum DamageSource
			{
			DAMAGE_SOURCE_NONE,						//built-in
			DAMAGE_SOURCE_GENERIC,					//built-in
			DAMAGE_SOURCE_SELF,						//built-in
			DAMAGE_SOURCE_RADIATION_EXTERNAL,		//built-in
			DAMAGE_SOURCE_RADIATION_DOSE_INTERNAL,	//built-in
			DAMAGE_SOURCE_FIRE,
			DAMAGE_SOURCE_ELECTRICITY,
			DAMAGE_SOURCE_CHEMICAL,
			DAMAGE_SOURCE_GRAVY ,
			DAMAGE_SOURCE_PSY,
			DAMAGE_SOURCE_BIO,
			DAMAGE_SOURCE_BLOWOUT,
			DAMAGE_SOURCE_CHEATER,
			DAMAGE_SOURCE_MASTER,
			DAMAGE_SOURCE_NUM,
			};
		enum FACTIONS
			{
...
//		const static uint8_t SUIT_PARAMETERS_NUM			= 1+2;//SuiteID[1] + Durability[2]
...
#endif //GAMETEMPLATE_TEMPORARY_CLASS_H