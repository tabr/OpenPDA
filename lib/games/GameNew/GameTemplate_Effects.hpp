...
*/
  ...
  GameCFG.RegisterNewPlayerEffect(EffectSafeShelter);

  PlayerEffect_HealClass* tmp1 = new PlayerEffect_HealClass(0, 1, 199, TemporaryClass::PLAYEREFFECT_TMP_1, (char*)"Сглаз");//50 ticks +1hp
  tmp1->SetHealValue(1);
  GameCFG.RegisterNewPlayerEffect(tmp1);

  PlayerEffect_HealClass* tmp2  = new PlayerEffect_HealClass(0, 1, 128, TemporaryClass::PLAYEREFFECT_TMP_2, (char*)"Сила Земли");//50 ticks +1hp
  tmp2->SetHealValue(1);
  GameCFG.RegisterNewPlayerEffect(tmp2);

  PlayerEffect_HealClass* tmp3 = new PlayerEffect_HealClass(0, 1, 50, TemporaryClass::PLAYEREFFECT_TMP_3, (char*)"Сифилис");//50 ticks +1hp
  tmp3->SetHealValue(1);
  GameCFG.RegisterNewPlayerEffect(tmp3);
