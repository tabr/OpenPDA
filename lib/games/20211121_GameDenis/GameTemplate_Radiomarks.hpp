...
GameCFG.RegisterNewRadiomark(new RadiomarkInstanceClass(7,	RadiomarkInstanceClass::RADIOMARK_TYPE_RADIATION_NEUTRON_FLUX,	1,                      0,                                  0,                      0));
GameCFG.RegisterNewRadiomark(new RadiomarkInstanceClass(8,	RadiomarkInstanceClass::RADIOMARK_TYPE_RADIATION_NEUTRON_FLUX,	1,                      0,                                  0,                      0));
GameCFG.RegisterNewRadiomark(new RadiomarkInstanceClass(9,	RadiomarkInstanceClass::RADIOMARK_TYPE_RADIATION_NEUTRON_FLUX,	1,                      0,                                  0,                      0));
GameCFG.RegisterNewRadiomark(new RadiomarkInstanceClass(10,	RadiomarkInstanceClass::RADIOMARK_TYPE_RADIATION_NEUTRON_FLUX,	1,                      0,                                  0,                      0));
GameCFG.RegisterNewRadiomark(new RadiomarkInstanceClass(11,	RadiomarkInstanceClass::RADIOMARK_TYPE_RADIATION_NEUTRON_FLUX,	2,                      0,                                  0,                      0));
GameCFG.RegisterNewRadiomark(new RadiomarkInstanceClass(12,	RadiomarkInstanceClass::RADIOMARK_TYPE_RADIATION_NEUTRON_FLUX,	3,                      0,                                  0,                      0));
...
GameCFG.RegisterNewRadiomark(new RadiomarkInstanceClass(16,	RadiomarkInstanceClass::RADIOMARK_TYPE_GRAVEYARD,				0,                      0,                                  0,                      0));
GameCFG.RegisterNewRadiomark(new RadiomarkInstanceClass(17,	RadiomarkInstanceClass::RADIOMARK_TYPE_GRAVEYARD,				0,                      0,                                  0,                      0));
GameCFG.RegisterNewRadiomark(new RadiomarkInstanceClass(18,	RadiomarkInstanceClass::RADIOMARK_TYPE_GRAVEYARD,				0,                      0,                                  0,                      0));
