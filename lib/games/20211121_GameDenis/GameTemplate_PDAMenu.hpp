...
//Menu->InsertBefore(new PDAMenu_ArtefactsConnectedClass);
...
//Menu->InsertBefore(new PDAMenu_AnomalyScanClass);
#ifdef MASTER_PDA
  {
...
//PDAMenu_Dummy0->addSubMenu(new PDAMenu_ActiveEffectsClass);
