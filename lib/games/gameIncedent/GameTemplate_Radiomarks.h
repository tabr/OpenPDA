...
GameCFG.Radiomarks.RegisterNew(1,	RadiomarkInstanceClass::RADIOMARK_TYPE_GRENADE,					1,											GrenadeClass::G_TYPE_GENERIC,                      				0,						0);
GameCFG.Radiomarks.RegisterNew(2,	RadiomarkInstanceClass::RADIOMARK_TYPE_RADIATION_ANOMALY,		1,											0,                      				0,						0);
//GameCFG.Radiomarks.RegisterNew(2,	RadiomarkInstanceClass::RADIOMARK_TYPE_RADIATION_ANOMALY,		0,											TemporaryClass::ANOMALY_ID_KISEL,		30,						255);
