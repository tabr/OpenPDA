...
#define GAMETEMPLATE_EFFECTS_H_
  ...
  //items ->
  PlayerEffect_HealClass* Item_StimPack                     = new PlayerEffect_HealClass(0, 1, 90);//90 ticks +1hp
  Item_StimPack->SetHealValue(1);
  ...
  PlayerEffect_DefDamageSourceClass* Item_Rad_X             = new PlayerEffect_DefDamageSourceClass(0, 60, 20);//60sec*20 = 20 min
  Item_Rad_X->SetDmgSrc(DamageSource_t::DAMAGE_SOURCE_RADIATION_EXTERNAL, 80);//80%
