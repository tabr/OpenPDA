...
GameCFG.Radiomarks.RegisterNew(1,	RadiomarkInstanceClass::RADIOMARK_TYPE_RADIATION_ANOMALY,		-5,											0,                      				0,						0);
GameCFG.Radiomarks.RegisterNew(2,	RadiomarkInstanceClass::RADIOMARK_TYPE_RADIATION_ANOMALY,		-5,											0,                      				0,						0);
GameCFG.Radiomarks.RegisterNew(3,	RadiomarkInstanceClass::RADIOMARK_TYPE_RADIATION_ANOMALY,		-5,											0,                      				0,						0);
GameCFG.Radiomarks.RegisterNew(4,	RadiomarkInstanceClass::RADIOMARK_TYPE_RADIATION_ANOMALY,		-4,											0,                      				0,						0);
GameCFG.Radiomarks.RegisterNew(5,	RadiomarkInstanceClass::RADIOMARK_TYPE_RADIATION_ANOMALY,		-4,											0,                      				0,						0);
GameCFG.Radiomarks.RegisterNew(6,	RadiomarkInstanceClass::RADIOMARK_TYPE_RADIATION_ANOMALY,		-4,											0,                      				0,						0);
...
GameCFG.Radiomarks.RegisterNew(30,	RadiomarkInstanceClass::RADIOMARK_TYPE_GRAVEYARD,				0,											0,                      				0,						0);
GameCFG.Radiomarks.RegisterNew(31,	RadiomarkInstanceClass::RADIOMARK_TYPE_GRAVEYARD,				0,											0,                      				0,						0);

GameCFG.Radiomarks.RegisterNew(32,	RadiomarkInstanceClass::RADIOMARK_TYPE_REVIVE,					0,											0,                      				0,						0);
GameCFG.Radiomarks.RegisterNew(33,	RadiomarkInstanceClass::RADIOMARK_TYPE_REVIVE,					0,											0,                      				0,						0);
